...
public class PlaceControllerTest extends AbstractIntegrated {
    ...
    private FieldDescriptor[] getPLaceRequestField() {
        return new FieldDescriptor[] {
                ...
                fieldWithPath("dayOfWeek[].placeId").description("공간Id"),
                fieldWithPath("hashtags[].hashtagName").description("해시태그1"),
                fieldWithPath("hashtags[].placeId").description("공간Id"),
                fieldWithPath("hashtags[].hashtagName").description("해시태그2"),
                fieldWithPath("hashtags[].placeId").description("공간Id"),
                fieldWithPath("hashtags[].hashtagName").description("해시태그3"),
                fieldWithPath("hashtags[].placeId").description("공간Id"),
    ...
    private FieldDescriptor[] getPlaceResponseField(String prefix) {
        return new FieldDescriptor[] {
                ...
                fieldWithPath(prefix+"address.id").description("주소 id"),
                fieldWithPath(prefix+"address.sigungu").description("시군구 주소"),
                fieldWithPath(prefix+"review.starRating").description("리뷰 별점"),
                fieldWithPath(prefix+"review.reviewCount").description("리뷰 개수"),
