...
//    @WithUserDetails(value = "Jane@naver.com", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    private FieldDescriptor[] getPlaceDetailResponseField(String prefix) {
        return new FieldDescriptor[] {
                ...
                fieldWithPath(prefix+"dayOfWeeks[].dayOfWeekName").description("월요일"),
                fieldWithPath(prefix+"hashtags[].hashtagName").description("해시태그1"),
                fieldWithPath(prefix+"facilitys[].facilityName").description("편의시설1"),
                fieldWithPath(prefix+"file.fileName").description("파일이름1"),
                fieldWithPath(prefix+"file.fileUrl").description("파일URL1"),
                fieldWithPath(prefix+"file.extension").description("파일확장자1"),
                fieldWithPath(prefix+"file.status").description("파일상태1"),
                fieldWithPath(prefix+"scrap").optional().description("스크랩"),
                fieldWithPath(prefix+"id").description("공간의 id"),
                fieldWithPath(prefix+"title").description("공간 제목"),
