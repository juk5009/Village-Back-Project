...
//    }
    ...
    public @ResponseBody ResponseEntity<ResponseDTO> savePlace(
        ...
        return new ResponseEntity<>(new ResponseDTO<>(1,1, "공간 데이터 등록 완료", save), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> updatePlace(
        ...
        return new ResponseEntity<>(new ResponseDTO<>(1,1, "공간 데이터 수정 완료", update), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deletePlace(
        ...
        return new ResponseEntity<>(new ResponseDTO<>(1,1, "공간 데이터 삭제 완료", null), HttpStatus.OK);
    }
