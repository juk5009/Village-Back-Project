...
insert into hashtag_tb (hashtag_name, place_id) values ('가까운곳', 1);
...
insert into place_tb (user_id, title, address_id, tel, notice, place_introduction_info, max_people, price_per_hour, start_time, end_time, category_id)
values (1, '좋은 공간', 1, '01012345678', '좋은 공간입니다.', '좋은 공간입니다. 이용해보세요!', 10, 5, NOW(), NOW(), 1);
insert into place_tb (user_id, title, address_id, tel, notice, place_introduction_info, max_people, price_per_hour, start_time, end_time, category_id)
values (2, '멋진 공간', 2, '01012345679', '멋진 공간입니다.', '멋진 공간입니다. 이용해보세요!', 10, 4, NOW(), NOW(), 1);
insert into place_tb (user_id, title, address_id, tel, notice, place_introduction_info, max_people, price_per_hour, start_time, end_time, category_id)
values (3, '편안한 공간', 3, '01012345680', '편안한 공간입니다.', '편안한 공간입니다. 이용해보세요!', 10, 3, NOW(), NOW(), 1);


insert into reservation_tb (user_id, place_id, date, start_time, end_time, people_num) values (1, 1, '2023-04-20', '2021-01-01T00:01', '2021-01-01T00:01', 2);
insert into reservation_tb (user_id, place_id, date, start_time, end_time, people_num) values (2, 2, '2023-04-20', '2021-01-01T00:01', '2021-01-01T00:01', 3);
insert into reservation_tb (user_id, place_id, date, start_time, end_time, people_num) values (1, 1, '2023-04-20', '2021-01-01T00:01', '2021-01-01T00:01', 4);

insert into scrap_tb (user_id, place_id, count) values(1, 1, 3);
insert into scrap_tb (user_id, place_id, count) values(1, 2, 5);
insert into scrap_tb (user_id, place_id, count) values(2, 1, 4);


insert into chat_room_tb (user_id, place_id, created_at) values (1, 1, NOW());
insert into chat_room_tb (user_id, place_id, created_at) values (2, 2, NOW());
insert into chat_room_tb (user_id, place_id, created_at) values (3, 3, NOW());
...
--
insert into chat_tb (user_id, send, chat_room_id, created_at) values (1, '안녕하세요!', 1, NOW());
insert into chat_tb (user_id, send, chat_room_id, created_at) values (2, '반갑습니다!', 1, NOW());
